  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: 900, marginBottom: 8 }}>{lang === "es" ? "Secciones" : "Sections"}</div>
          <div style={{ display: "grid", gap: 8, fontSize: 14 }}>
            <Link href={routes.home} style={{ textDecoration: "none" }}>
              {lang === "es" ? "Inicio" : "Home"}
            </Link>
            <Link href={routes.services} style={{ textDecoration: "none" }}>
              {lang === "es" ? "Servicios" : "Services"}
            </Link>
            <Link href={routes.projects} style={{ textDecoration: "none" }}>
              {lang === "es" ? "Proyectos" : "Projects"}
            </Link>
            <Link href={routes.contact} style={{ textDecoration: "none" }}>
        ...
        <div>
          <div style={{ fontWeight: 900, marginBottom: 8 }}>{lang === "es" ? "Contacto" : "Contact"}</div>
          ...
          <div style={{ display: "grid", gap: 10, fontSize: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 12, opacity: 0.7 }}>{lang === "es" ? "Horario" : "Hours"}</div>
              <div style={{ opacity: 0.85 }}>
                {lang === "es" ? "L–V 9:00–19:00 (CET)" : "Mon–Fri 9:00–19:00 (CET)"}
              </div>
            </div>
          </div>
        </div>
      ...
      >
        © {new Date().getFullYear()} S&amp;G Ingenieros — Salamanca / San Clemente (Cuenca)
      </div>
    </footer>
  );
}